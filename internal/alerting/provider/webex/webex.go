// Package webex implements the alerting provider that sends alerts to a Webex space through an incoming
// webhook.
package webex
...
// Config is the configuration of the Webex provider. It is both the default configuration and the shape of the
...
// Body is the JSON payload posted to the Webex webhook. The provider only fills in Markdown.
type Body struct {

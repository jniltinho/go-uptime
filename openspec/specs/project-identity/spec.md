...
## Purpose
A identidade do projeto: o nome em cada forma, o que foi renomeado quando ele deixou de se chamar Gatus (v7.0.0), o que fica com o nome antigo por compatibilidade ou porque vive em sistemas de terceiros, e o crédito ao projeto de origem.
## Requirements

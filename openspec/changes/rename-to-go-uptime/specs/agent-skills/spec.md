...
- FROM: `### Requirement: Skills fora do escopo do Gatus`
- TO: `### Requirement: Skills fora do escopo`

- FROM: `### Requirement: Regras do fork para agentes`
- TO: `### Requirement: Regras para agentes`
